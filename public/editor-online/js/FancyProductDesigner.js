...
var FPDToolbarSide = function($uiElementToolbar, fpdInstance) {
	...
	this.update = function(element) {
		...
		if(showScale || element.rotatable || element.draggable || element.zChangeable || element.__editorMode) {
			...
			_lockUniScaling(element.lockUniScaling);
			_togglePanelTool('transform', 'uniscaling-locker', (element.uniScalingUnlockable || element.__editorMode));
			_togglePanelTool('transform', 'angle', Boolean(element.rotatable || element.__editorMode));
			_togglePanelTool('transform', 'position', element.draggable || element.__editorMode);
			_togglePanelTool('transform', 'flip', element.draggable || element.__editorMode);
			_togglePanelTool('transform', 'layer-depth', element.zChangeable || element.__editorMode);
