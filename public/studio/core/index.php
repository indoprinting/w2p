<?php
    ...
    setcookie("code_material", $_GET['m']);
    setcookie("code_panjang", $_GET['l']);
    setcookie("code_lebar", $_GET['w']);
    setcookie("code_finishing", $_GET['f']);
    if(isset($_COOKIE['session_cart']) == null && $_GET['product_base'] == null && $_GET['m'] == null && $_GET['l'] == null && $_GET['w'] == null && $_GET['f'] == null){
...
<body>
	<div class="wrapper">
		<div id="LumiseDesign" data-site="https://indoprinting.co.id" data-processing="true" data-msg="<?php echo $lumise->lang('Initializing'); ?>..">
