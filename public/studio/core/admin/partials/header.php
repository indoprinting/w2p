...
<html lang="en">
	<head>
		...
		<title><?php echo (isset($title) ? $title : 'Indoprinting Design Control Panel'); ?></title><?php
}
...
?>
	...
	<div class="lumise_sidebar">
		...
		?>
		<ver><span><a href="https://indoprinting.co.id" target=_blank>IDP Studio Version</span> <?php echo LUMISE; ?></a></ver>
	</div>
