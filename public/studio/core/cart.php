        ...
        foreach ($_FILES as $cart_id => $file) {
			...
			if($current_product !== null && strpos($item->product_id, 'variable') === false){
				...
				$items_cart[ $cart_id ] = array(
	                ...
	                'data'          => $item,
	                'qty'           => $qty,
                    'bahan'         => isset($_COOKIE["code_material"])? $_COOKIE["code_material"] : null,
                    'finishing'     => isset($_COOKIE["code_finishing"])? $_COOKIE["code_finishing"] : null,
                    'length'        => isset($_COOKIE["code_panjang"])? $_COOKIE["code_panjang"] : null,
                    'width'         => isset($_COOKIE["code_lebar"])? $_COOKIE["code_lebar"] : null,
