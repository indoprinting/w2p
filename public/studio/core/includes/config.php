...
class lumise_cfg extends lumise_tmpl_register{
    ...
    public $settings = array(
		...
		'logo' => '',
		'favicon' => '',
		'logo_link' => 'https://indoprinting.com',
		'primary_color' => '',
		'conditions' => '',
    ...
    public function init() {
	    ...
	    $this->js_lang = array(
			...
			'10'=> $lumise->lang('Buat Kode QR'),
			'11'=> $lumise->lang('Masukkan teks atau link'),
			'12'=> $lumise->lang('Pilih warna untuk Kode QR'),
			'13'=> $lumise->lang('Pilih warna'),
			...
			'39'=> $lumise->lang('Tautan telah disalin ke clipboard Anda'),
			'40'=> $lumise->lang('Harap simpan desain Anda terlebih dahulu untuk membuat tautan'),
			'41'=> $lumise->lang('Anda belum memberikan izin untuk melihat atau mengedit desain ini'),
			'42'=> $lumise->lang('Tidak ada item'),
			'43'=> $lumise->lang('Kembali ke kategori'),
			'44'=> $lumise->lang('Tunggu sebentar..'),
			'45'=> $lumise->lang('Sebelumnya'),
			'46'=> $lumise->lang('Selanjutnya'),
			'47'=> $lumise->lang('Hapus gambar ini'),
			'48'=> $lumise->lang('Edit desain ini'),
			'49'=> $lumise->lang('Membuat salinan'),
			'50'=> $lumise->lang('Download design'),
			'51'=> $lumise->lang('Delete design'),
			'52'=> $lumise->lang('Klik untuk mengedit judul desain'),
			'53'=> $lumise->lang('Peringatan: Gambar yang terlalu besar dapat memperlambat editor'),
			'54'=> $lumise->lang('Judul Desain'),
			'55'=> $lumise->lang('Kesalahan saat memuat font'),
			'56'=> $lumise->lang('Kategori'),
			'57'=> $lumise->lang('Semua Kategori'),
			'58'=> $lumise->lang('Design options'),
			'59'=> $lumise->lang('Pertahankan desain saat ini'),
			'60'=> $lumise->lang('Select design from templates'),
			'61'=> $lumise->lang('Design from blank'),
			'62'=> $lumise->lang('Start design now!'),
			'63'=> $lumise->lang('Cari produk'),
			'64'=> $lumise->lang('Printing'),
			'65'=> $lumise->lang('Side'),
			'66'=> $lumise->lang('Jumlah'),
			'67'=> $lumise->lang('Tabel harga'),
			'68'=> $lumise->lang('Rincian'),
			'69'=> $lumise->lang('Lebih'),
			'70'=> $lumise->lang('Berhasil, lihat keranjang lengkap dan checkout di menu "Keranjang Saya"'),
			'71'=> $lumise->lang('Keranjang Anda kosong'),
			'72'=> $lumise->lang('Editing'),
			'73'=> $lumise->lang('Detail keranjang Anda'),
			...
			'96'=> $lumise->lang('Kesalahan! Desain Anda kosong, silakan tambahkan objek'),
			...
			'109'=> $lumise->lang('Desain Anda telah berhasil disimpan!'),
			'110'=> $lumise->lang('Draft was saved'),
			'111'=> $lumise->lang('Load draft'),
			'112'=> $lumise->lang('Load the draft designs which was saved before'),
			'113'=> $lumise->lang('Berhasil! Perubahan Anda berikutnya akan diperbarui menjadi draf secara otomatis'),
			...
			'118'=> $lumise->lang('Item keranjang Anda telah berhasil diperbarui'),
			...
			'130'=> $lumise->lang('Salin tautan'),
			'131'=> $lumise->lang('Buka tautan'),
			'132'=> $lumise->lang('Hapus tautan'),
			'133'=> $lumise->lang('Apakah Anda yakin ingin menghapus tautan ini?'),
			...
			'172'=> $lumise->lang('Keranjang anda sudah diperbarui'),
			'173'=> $lumise->lang('Lihat detail keranjang'),
			'174'=> $lumise->lang('Mulai produk baru'),
			'175'=> $lumise->lang('Checkout'),
			...
			'180'=> $lumise->lang('Rumus perhitungan harga'),
			...
			'188'=> $lumise->lang('Desain Anda disimpan di'),
			'189'=> $lumise->lang('Simpan design saat ini untuk digunakan atau diperbarui nanti'),
			'190'=> $lumise->lang('Simpan ke Desain Saya'),
			...
			'207'=> $lumise->lang('Deskripsi'),
			'208'=> $lumise->lang('Kesalahan, tidak ada konfigurasi untuk produk yang Anda pilih'),
			'209'=> $lumise->lang('Kesalahan, tidak ada konfigurasi untuk produk ini'),
			'210'=> $lumise->lang('Kesalahan! Harap design semua stages sebelum menambahkan ke keranjang'),
			'211'=> $lumise->lang('Simpan desain Anda untuk digunakan nanti'),
			'212'=> $lumise->lang('GUNAKAN INI'),
