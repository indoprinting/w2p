...
class lumise_views extends lumise_lib {
    ...
    public function nav(){
        ...
        if(count($items) > 0 && $_COOKIE['session_cart'] == null){
            header("Location: https://indoprinting.co.id/studio/cart.php");
        }
        ?>
        ...
        <ul data-block="left" data-resp="file">
            ...
            <li data-tool="designs" data-callback="designs">
                ...
                <ul data-view="sub">
                    <header>
                        <h3>
                            <?php echo $this->main->lang('Desain saya'); ?>
                            <span id="lumise-designs-search">
							<input type="search" placeholder="<?php echo $this->main->lang('Cari desain'); ?>" />
						</span>
                        </h3>
                    ...
                    <ul data-view="sub" class="lumise-tabs-nav" data-align="center" id="lumise-shares-wrp" data-nav="link">
                        ...
                        <li data-view="link" data-active="true">
                            <p data-phase="1" class="mb1">
                                <?php echo $this->main->lang('Buat tautan untuk membagikan desain saat ini untuk semua orang yang anda inginkan'); ?>
                            </p>
                            <p data-view="link" class="mb1" data-phase="1">
                                <input type="text" placeholder="<?php echo $this->main->lang('Masukkan judul desain'); ?>" id="lumise-share-link-title" />
                            </p>
                            <p data-phase="1">
                                <button class="lumise-btn right" data-func="create-link">
                                    <?php echo $this->main->lang('Buat tautan'); ?>
                                </button>
                                <button class="lumise-btn right white mr1"  data-nav="history" data-func="nav">
                                    <?php echo $this->main->lang('Lihat riwayat'); ?>
                                </button>
                            </p>
                            <p class="notice success" data-phase="2">
                                <?php echo $this->main->lang('Tautan Anda telah berhasil dibuat'); ?>
                            </p>
                            <p data-view="link-share" data-phase="2" data-func="copy" data-msg="<?php
                            echo $this->main->lang('Tautan telah disalin');
                            ?>" title="<?php
                            echo $this->main->lang('Klik untuk menyalin tautan');
                            ?>"></p>
                            <p class="mt1 mb1 right" data-phase="2">
                                <b><?php echo $this->main->lang('Bagikan ke'); ?>:</b>
                            ...
                            <p class="mt1" data-phase="2">
                                <button class="lumise-btn right gray" data-func="do-again">
                                    <?php echo $this->main->lang('Buat yang lain'); ?>
                                </button>
                                <button class="lumise-btn right white mr1"  data-nav="history" data-func="nav"><?php echo $this->main->lang('Lihat riwayat'); ?></button>
                            </p>
                        </li>
            ...
            <li data-tool="help">
			<span>
				<?php echo $this->main->lang('Bantuan'); ?>
			</span>
                <ul data-view="sub" class="lumise-tabs-nav">
                    <li data-view="header">
                        ...
                        <nav>
                            ...
                            $about = new stdClass();
                            $about->title = $this->main->lang('Tentang');
            ...
            if (in_array('back', $components)){
                ...
                <li class="back_mobile">
                    ...
                    global $lumise;
                    require('autoload.php');
                    $data_cart = $lumise->connector->get_session('lumise_cart');
                    $cart_session = isset($data_cart['items']) ? $data_cart['items'] : array();
                    ?>
                    <?php if (count($cart_session) > 0) : ?>
                        <a href="https://indoprinting.co.id/studio/cart.php">Kembali</a>
                    <?php else: ?>
                        <a href="<?php echo $back_link;?>">Kembali</a>
                    <?php endif; ?>
...
<!--                </li>-->
                <!--        Icon Keranjang, because just only checkout 1 item, this deactivated-->
            <?php if (count($cart_session) > 0) : ?>
            <?php else : ?>
                <li data-tool="cart" id="lumise-cart-options">
                    ...
                    <div data-view="sub" data-align="right" id="lumise-cart-items">
                        <header>
                            <h3><?php echo $this->main->lang('Keranjang Saya'); ?></h3>
                            <i class="lumisex-android-close close" title="close"></i>
                        </header>
                        <ul data-view="items"></ul>
                        <footer>
                            <a href="#details" data-func="details" data-view="cart-details">
                                <?php echo $this->main->lang('Detail Keranjang'); ?> <i class="lumisex-android-open"></i>
                            </a>
                            <a href="#checkout" data-func="checkout" class="lumise-btn-primary" id="btn-session">
            ...
            ?>
                <li id="back-btn">
                    <?php if (count($cart_session) > 0) : ?>
                        <a href="https://indoprinting.co.id/studio/cart.php" class="back_shop"><?php echo $this->main->lang('Kembali'); ?></a>
                    <?php else: ?>
                        <a href="<?php echo $back_link; ?>" class="back_shop"><?php echo $this->main->lang('Kembali'); ?></a>
                    <?php endif; ?>
                </li>
            <?php } ?>
                <!-- Avalable hook: cart_icon -->
            <?php
            ...
            ?>
                <li id="lumise-proceed">
                    <button id="lumise-cart-action" class="lumise-btn-primary" data-add="<?php echo $this->main->lang('Masukkan Keranjang'); ?>" data-update="<?php echo $this->main->lang('Update cart'); ?>" data-action="update-cart">
                        <span><?php echo $this->main->lang('Masukkan Keranjang'); ?></span>
                        <i class="lumisex-android-arrow-forward"></i>
                    </button>
                </li>
                <script type="text/javascript">
                    document.getElementById('lumise-cart-action').onclick = function() {
                        setTimeout(function() {
                ...
                <div id="lumise-bug" class="lumise-tab-body-wrp lumise-left-form">
                    <bug>
                        ...
                        <p data-view="tips">
                            ...
                            <a href="https://indoprinting.co.id" target=_blank>indoprinting.co.id</a>
