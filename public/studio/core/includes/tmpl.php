				...
				"content" =>
					'<header>
						...
						(
							...
							'<a href="https://indoprinting.co.id/studio/products.php?category_id=2"><button class="lumise-btn white">
								'.$lumise->lang('Ubah Template').'
				...
				"content" =>
					'<header>
						<span class="lumise-templates-search">
							<input type="search" id="lumise-templates-search-inp" placeholder="'.$lumise->lang('Cari templates').'" />
						...
						<div class="lumise-template-categories" data-prevent-click="true">
							<button data-func="show-categories" data-type="templates">
								<span>'.$lumise->lang('Semua kategori').'</span>
								<i class="lumisex-ios-arrow-forward"></i>
							</button>
						</div>
						<div style="margin-top: 2px; text-align: left">
						     <span style="color: yellow; font-size: 70%;"><i class="far fa-info"></i> Silahkan pilih template sesuai dengan ukuran</span>
                        </div>
					</header>
