        ...
        @foreach ($orders as $id_o => $order)
            <div class="profile-wrapper">
                ...
                <div class="profile-detail">
                    <a href=" javascript:void(0);" class="transaksi submit" data-payment="{{ $id_o }}">Detail transaksi</a>
                    ...
                    {{-- <a href="javascript:void(0);" class="review" data-toggle="modal" data-target="#review{{ $id_o }}">Tulis review produk</a>
