    ...
    <div class="card shadow p-3">
        ...
        <form action="{{ route('save.profile') }}" method="POST" class="form-horizontal formAddProduct">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <x-input type="text" name="name" value="{{ old('name') ?? Auth()->user()->name }}" />
                    @if (!Auth()->user()->name)
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <x-input type="text" name="email" value="{{ old('email') ?? Auth()->user()->email }}" />
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <x-input type="text" name="phone" value="{{ old('phone') ?? Auth()->user()->phone }}" />
                </div>
            </div>
