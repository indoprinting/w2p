                            ...
                            <div class="card shadow profile-cust mb-3">
                                <div class="card-body">
                                    ...
                                    <ul class="list-profile">
                                        <li><a href="{{ route('profile') }}" class="icon-profile fab fa-shopify"> Daftar Belanja</a></li>
                                        <li><a href="{{ route('edit.profile') }}" class="icon-profile fas fa-user"> Pengaturan Akun</a></li>
                                        <li><a href="{{ route('edit.address') }}" class="icon-profile2 fas fa-house-user"> Alamat</a></li>
                                        <li><a href="{{ route('edit.password') }}" class="icon-profile2 fas fa-key"> Ubah Password</a></li>
                                        <li><a href="{{ route('checkout') }}" class="icon-profile fas fa-shopping-cart"> Checkout</a></li>
                                        <li><a href="{{ route('queue.online') }}" class="icon-profile fas fa-ticket-alt"> Registrasi Pelayanan Outlet</a></li>
                                    </ul>
