            ...
            <div class="payment-bank">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="td-img"><img src="{{ asset('images/logo/logo_bri.png') }}" alt="" class="img-bank"></td>
                    ...
                    <tr>
                        ...
                        <td class="td-img"><img src="{{ asset('images/logo/logo_bni.png') }}" alt="" class="img-bank"></td>
                        <td>CV. Indoprinting</td>
                        <td>Rp 10.000</td>
                    </tr>
                    <tr>
                        ...
                        <td class="td-img"><img src="{{ asset('images/logo/logo_mandiri.png') }}" alt="" class="img-bank"></td>
                        <td>CV. Indoprinting</td>
                        <td>Rp 10.000</td>
                    </tr>
                    <tr>
                        ...
                        <td class="td-img"><img src="{{ asset('images/logo/logo_bca.png') }}" alt="" class="img-bank"></td>
