...
@section('main')
    <div class="container-fluid">
        <a href="#" id="idp-studio">
            <img src="{{ adminUrl('assets/images/admin/idp-studio-early-akses.png') }}" alt="" style="max-width: 100%;" class="img-order">
        </a>
    ...
    <script>
        ...
        document.getElementById('idp-studio').onclick = function() {
            Swal.fire({
                icon: 'info',
                title: 'Akses Terbatas!',
                text: 'Hanya untuk pelanggan yang memiliki akun di indoprinting.co.id',
                footer: '<a href="https://indoprinting.co.id/login" style="color: mediumpurple;">Daftar Sekarang untuk mendapatkan Akses</a>'
            })
        }
    </script>
